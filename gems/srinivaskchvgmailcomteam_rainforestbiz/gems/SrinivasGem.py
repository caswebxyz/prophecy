...
class SrinivasGem(ComponentSpec):
    name: str = "SrinivasGem"
    category: str = "Transform"
    gemDescription: str = "Edits column names or values using expressions."
    docUrl: str = "https://docs.prophecy.io/low-code-spark/gems/transform/SrinivasGem/"
    ...
    class SrinivasGemProperties(ComponentProperties):
    ...
    def onClickFunc(self, portId: str, column: str, state: Component[SrinivasGemProperties]):
    ...
    def allColumnsSelectionFunc(self, portId: str, state: Component[SrinivasGemProperties]):
    ...
    def expressions_to_csv(self, state: Component[SrinivasGemProperties]) -> Component[SrinivasGemProperties]:
        exprCSV = []
    ...
    def csv_to_expressions(self, state: Component[SrinivasGemProperties]) -> Component[SrinivasGemProperties]:
        exprs = []
    ...
    def dialog(self) -> Dialog:
        expTable = ExpTable("SrinivasGem Expression") \
            .enableVirtualization() \
            .bindProperty("expressions") \
            .withCopilotEnabledExpressions().allowCopilotExpressionsFix()
        bulkEdit = StackLayout(height="100%") \
            .addElement(
            NativeText("Edit the SrinivasGem expressions in the field below. Use the format of \"name,expr\".")
        ).addElement(
        ...
        return Dialog("SrinivasGem").addElement(
    ...
    def validate(self, context: WorkflowContext, component: Component[SrinivasGemProperties]) -> List[Diagnostic]:
        diagnostics = []
    ...
    def onChange(self, context: WorkflowContext, oldState: Component[SrinivasGemProperties], newState: Component[SrinivasGemProperties]) -> Component[
        SrinivasGemProperties]:
    ...
    def getCPStmt(self, component: Component[SrinivasGemProperties]) -> Optional[SelectStmt]:
        return SelectStmt(
            component.component,
    ...
    class SrinivasGemCode(ComponentCode):
        def __init__(self, newProps):
            self.props: SrinivasGem.SrinivasGemProperties = newProps
